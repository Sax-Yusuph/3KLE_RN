  ...
  return (
    <View style={styles.container}>
      ...
      <AppCustomText style={[styles.subText, {fontSize: 13}]}>
        Take a clear picture of your face. This will help verify your identity.
        You can change the photo later.
      </AppCustomText>
          ...
          <AppCustomText style={{color: colors.RED_COLOR, fontSize: 18}}>
            *
            <AppCustomText style={{color: colors.BLACK_COLOR, fontSize: 11}}>
              Note that photos taken with dark eyewares and face coverings may
              not be accepted.
            </AppCustomText>
          </AppCustomText>
        </View>
