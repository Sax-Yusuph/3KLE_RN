...
import { TransparentButton, CountryPickerWithName } from '@form'
import routes from '../../../../navigation/navigators/routes'
import colors from '../../../themes/colors'
import styles from '../style'

export const ProofOfidentity = (props: any) => {
		...
		<View style={[styles.container, { padding: 20 }]}>
			...
			<View style={styles.buttonBottom}>
				<TransparentButton
					...
					marginBottom={15}
					title={'Skip for Now'}
					onPress={() => navigation.navigate(routes.REGISTER.STEP_NINE)}
					color={'#0A5D87'}
				/>
			</View>
		</View>
...
export const ProofOfidentity = (props: any) => {
  ...
  return (
    <View style={[styles.container, {padding: 20}]}>
      <AppCustomText style={[styles.header, {fontSize: 23}]}>
        PROOF OF IDENTITY
      </AppCustomText>
      <AppCustomText style={[styles.subText, {fontSize: 13}]}>
        This is to help us verify that you are a legitimate citizen of your
        country of choice.
      </AppCustomText>
      <View style={{marginTop: 25}}>
        <AppCustomText
        ...
        <CountryPickerWithName />
        <AppCustomText style={localStyles.header}>
          Required for Nigerians
        </AppCustomText>
        <View style={localStyles.card}>
          <View style={localStyles.cardRow}>
            <View style={localStyles.cardIcon}>
